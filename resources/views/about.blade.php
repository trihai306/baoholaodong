...
<nav class="flex text-sm" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-2">
        ...
        <li class="text-secondary-800 font-medium">Giới thiệu</li>
    </ol>
</nav>
@endsection
    ...
    <section class="py-16 lg:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
                <div>
                    <div class="inline-flex items-center px-4 py-2 bg-primary-50 text-primary-600 text-sm font-medium rounded-full mb-6">
                        <i class="fas fa-info-circle mr-2"></i>Về chúng tôi
                    </div>
                    <h1 class="text-3xl lg:text-5xl font-extrabold text-secondary-900 leading-tight mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-sm font-medium text-secondary-700">{{ $item }}</span>
                        </div>
                        @endforeach
                    </div>
                </div>
                <div class="mt-12 lg:mt-0">
                    <div class="relative">
                        ...
                        <div class="relative bg-gradient-to-br from-secondary-800 to-secondary-900 rounded-3xl p-10 lg:p-14 text-center">
                            <i class="fas fa-hard-hat text-7xl text-primary-400 mb-6"></i>
                            <h3 class="text-2xl font-bold text-white mb-3">An toàn là trên hết</h3>
                            <p class="text-secondary-400">Bảo vệ người lao động - Bảo vệ tương lai</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 bg-secondary-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 lg:p-8 text-center border border-secondary-100 hover:shadow-xl transition">
                    <div class="w-14 h-14 mx-auto mb-4 bg-gradient-to-br {{ $stat['color'] }} rounded-2xl flex items-center justify-center shadow-lg">
                        <i class="fas {{ $stat['icon'] }} text-white text-xl"></i>
                    </div>
                    <div class="text-3xl font-extrabold text-secondary-900 mb-1">{{ $stat['number'] }}</div>
    ...
    <section class="py-16 lg:py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14">
                <h2 class="text-3xl lg:text-4xl font-extrabold text-secondary-900 mb-3">Giá trị cốt lõi</h2>
                <p class="text-secondary-500 max-w-2xl mx-auto">Những cam kết mà chúng tôi luôn tuân thủ trong suốt quá trình hoạt động</p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="text-center p-8 rounded-2xl border border-secondary-100 hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <h3 class="text-xl font-bold text-secondary-900 mb-3">{{ $value['title'] }}</h3>
                    <p class="text-secondary-500 leading-relaxed">{{ $value['desc'] }}</p>
                </div>
                @endforeach
            </div>
        </div>
